...
public class playerPreLoginEvent implements Listener {
	...
	public void onPlayerPreLogin(AsyncPlayerPreLoginEvent e)
	{
		...
		if(bd != null) e.disallow(AsyncPlayerPreLoginEvent.Result.KICK_BANNED, PunishmentSystem.getBannedMessage(bd.nick(), bd.bannedByNick(), bd.reason(), bd.expiresTimestamp(), bd.bannedDate()));
	}
}
